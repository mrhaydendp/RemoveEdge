...
& 'C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe' --uninstall --system-level --verbose-logging --force-uninstall

# Create registry file that tells Windows you have the old Edge browser (disables updates)
